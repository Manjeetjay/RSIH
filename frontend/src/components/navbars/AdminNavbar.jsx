            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-16 items-center">
                    ...
                    <div className="hidden md:flex items-center gap-6">
                        ...
                        <NavLink to="/dashboard/admin/problems">Problems</NavLink>
                        <NavLink to="/dashboard/admin/spocs">SPOCs</NavLink>
                        <NavLink to="/dashboard/admin/registrations">Registrations</NavLink>
                        <NavLink to="/dashboard/admin/submissions">Submissions</NavLink>
                    </div>
