  ...
  const features = [
    {
      icon: "🚀",
      title: "Mission",
      description: "Empower young innovators to solve real-world problems and build practical solutions that can impact industries and communities across India."
    },
    {
      icon: "🤝",
      title: "Collaboration",
      description: "Connect institutions, SPOCs, team leaders, and administrators in one digital ecosystem for seamless communication and coordination."
    },
    {
      icon: "🏆",
      title: "Innovation",
      description: "Encourage students to innovate, create, and present groundbreaking ideas addressing the nation's most pressing challenges."
    },
    {
      icon: "🎯",
      title: "Impact",
      description: "Transform innovative ideas into implementable solutions that can make a real difference in society and drive technological advancement."
    },
    {
      icon: "🌟",
      title: "Excellence",
      description: "Foster a culture of excellence, creativity, and problem-solving among India's brightest young minds through competitive innovation."
    },
    {
      icon: "📚",
      title: "Learning",
      description: "Provide a platform for students to learn, grow, and develop practical skills while working on meaningful real-world projects."
    }
  ];
