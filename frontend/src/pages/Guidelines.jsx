...
import { FaPenNib, FaCheckCircle, FaUsers, FaBullseye, FaLightbulb, FaTrophy, FaStickyNote } from "react-icons/fa";
                  ...
                  <div className="md:w-5/12 w-full">
                    <div className="bg-white shadow-xl rounded-2xl p-6 border-l-4 border-blue-600 hover:shadow-2xl transition-all">
                      <div className="flex items-start gap-4 mb-3">
                        <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${colorClasses[step.color]} flex items-center justify-center text-white text-2xl shadow-lg`}>
                          <step.icon />
                        </div>
